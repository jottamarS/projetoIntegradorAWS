...
// Consulta SQL para somar os serviços por categoria
$sql_code = "SELECT categoria, COUNT(*) as quantidade FROM servicos WHERE YEAR(data_realizacao) = YEAR(CURDATE()) GROUP BY categoria";
$result = $mysqli->query($sql_code);

$dados = [];
while ($row = $result->fetch_assoc()) {
    $dados[$row['categoria']] = $row['quantidade'];
}

// Prepare os dados para o gráfico
$categorias = ['Cabelo', 'Podologia', 'Sobrancelha']; // Adicione todas as categorias aqui
$quantidades = [];

foreach ($categorias as $categoria) {
    $quantidades[] = isset($dados[$categoria]) ? $dados[$categoria] : 0; // Pega a quantidade ou 0 se não existir
}

// Converte os dados para JSON
$dadosJson = json_encode($quantidades);
$categoriasJson = json_encode($categorias);


// Inicializa um array para os ganhos mensais
$ganhosMensais = array_fill(0, 12, 0); // 12 meses

// Consulta SQL para obter a soma dos ganhos por mês
...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        $mes = (int)$row['mes'] - 1; // Ajusta o índice (0-11)
        $ganhosMensais[$mes] = $row['total_ganho'];
    }
}

// Converte o array de ganhos para JSON para uso no JavaScript
$ganhosMensaisJson = json_encode($ganhosMensais);

// Definindo a data atual e o primeiro dia do mês atual
$dataAtual = date('Y-m-d');
$primeiroDiaMes = date('Y-m-01');

// 1. Ganhos mensais: Soma todos os serviços validados no mês vigente
...
// 2. Serviços pendentes de aprovação: Quantidade de itens com status 'aguardando aprovação'
...
// 3. Serviços prestados: Quantidade de serviços validados
...
// 4. Serviços pendentes: Soma de todos os serviços Agendados
...
<body id="page-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Nome e Sobrenome</span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo number_format($ganhos, 2, ',', '.'); ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Serviços pendentes de aprovação</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $pendentesAprovacao; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Serviços pendentes</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $servicosPendentes; ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="small font-weight-bold">Hidratação <span class="float-right">40</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Pintura de cabelo <span
                                            class="float-right">60</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 60%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Manicure <span class="float-right">80</span>
                                    </h4>
                                    <div class="progress mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Adicione novas funcionalidades ativando a versão <a target="_blank"
                                        ...
                                        pagamentos e funcionalidades ótimas que dariam muito trabalho para fazer!</p>
    ...
    <script>
        var ganhosMensais = <?php echo $ganhosMensaisJson; ?>; // Exportando a variável JSON
    </script>

    <!-- Inclua seu arquivo JavaScript externo aqui -->
    <script src="js/demo/chart-area-demo.js"></script>
