...
if (isset($_POST['cadastrar_servico'])) {
    ...
    $sql_code = "INSERT INTO servicos (servico, preco, categoria) VALUES ('$servico', '$preco', '$categoria')";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="">
                        ...
                        <button type="submit" name="cadastrar_servico" class="btn btn-primary">Cadastrar
                            Serviço</button>
                    </form>
                </div>
