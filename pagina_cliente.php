...
if (isset($_GET['idAgendamento'])) {
    $idAgendamento = $mysqli->real_escape_string($_GET['idAgendamento']);


    $sql = "UPDATE agendamento SET status = 'Cancelado' WHERE idAgendamento = '$idAgendamento'";
...
$sql_code = "SELECT * FROM agendamento WHERE idCliente = '$idCliente' AND status = 'Agendado'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 style="text-align: center;">Serviços Agendados</h2>
                    <?php if ($sql_query->num_rows > 0): ?>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php while ($agendamento = $sql_query->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editar_agendamentos.php?idAgendamento=<?php echo htmlspecialchars($agendamento['idAgendamento']); ?>"
                                                class="btn btn-primary">Editar</a>
                                            <a href="pagina_cliente.php?idAgendamento=<?php echo htmlspecialchars($agendamento['idAgendamento']); ?>"
                    ...
                    <?php else: ?>
                        <div class="alert alert-info" style="text-align: center;">Nenhum agendamento aprovado.</div>
                    <?php endif; ?>
                </div>
